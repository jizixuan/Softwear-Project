...
//        test();
    ...
    private void setScrollerHeight() {
        ...
        int height = size.y;
        //动态设置高度
        SmartRefreshLayout.LayoutParams linearParams =(SmartRefreshLayout.LayoutParams) sv4.getLayoutParams();
    ...
    public void getY() {
        ...
        Request request = new Request.Builder()
                .url(ServerConfig.SERVER_HOME + "IconItemGetAllNumByMonthOut")
...
//                setyDataList(result);
    ...
    private void initViews() {
        ...
        refreshLayout = view.findViewById(R.id.srll_out_mouth);
    }
}
