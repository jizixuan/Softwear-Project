...
public class WeekOutFragment extends Fragment {
    private View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_out_week,container,false);
        initViews();
//        test();
        initData();
        setRefreshLayout();
    ...
    public void getY() {
        ...
        Request request = new Request.Builder()
                .url(ServerConfig.SERVER_HOME + "IconItemGetAllByWeekOut")
...
//                setyDataList(result);
    ...
    private void setScrollerHeight() {
        ...
        int height = size.y;
        //动态设置高度
        SmartRefreshLayout.LayoutParams linearParams =(SmartRefreshLayout.LayoutParams) sv5.getLayoutParams();
        linearParams.height=height-810;
        sv5.setLayoutParams(linearParams);
    }
    /**
     * 设置跳转动画
     */
    ...
    private void initViews() {
        sv5 = view.findViewById(R.id.sv5);
        list = view.findViewById(R.id.lv_icon_fragment_out);
        lineChart = view.findViewById(R.id.demo_linechart3);//绑定控件
        all = view.findViewById(R.id.tv_icon_week);
        average = view.findViewById(R.id.tv_icon_week_average);
        refreshLayout = view.findViewById(R.id.srll_out_week);
    }
}
