...
public class RobotActivity extends Fragment {
    ...
    private List<com.example.myapplication.robot.MyDataSet> dataList;//存储对话的集合
    private com.example.myapplication.robot.SQLiteConsole sqlConsole;//数据库控制台
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        root = inflater.inflate(R.layout.activity_robot, container, false);
        appInit();

        RadioGroup radioGroup = (RadioGroup) root.findViewById(R.id.radio);
    ...
    public void appInit(){
        ...
        sqlConsole = new SQLiteConsole(getContext().getApplicationContext());
        dataList = sqlConsole.queryAll();//获取数据库中全部的数据
        adapter = new MyAdapter();
        listView = (ListView) root.findViewById(R.id.textlist);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TextView textView = (TextView) root.findViewById(R.id.editText);
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            url = new URL("http://api.qingyunke.com/api.php?key=free&msg="+ URLEncoder.encode(textHead+textData, "utf-8"));
...
//    }
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {//当调用notifyDataSetChanged方法时会自动执行此方法
            View view = convertView!=null?convertView: View.inflate(getContext().getApplicationContext(),R.layout.my_list_item,null);
