...
public class YearOutFragment extends Fragment {
    private View view;
    ...
    List<String> xDataList = getX();// x轴数据源
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_out_year,container,false);
        initViews();
//        test();
        initData();
        setRefreshLayout();
    ...
    private void setScrollerHeight() {
        ...
        int height = size.y;
        //动态设置高度
        SmartRefreshLayout.LayoutParams linearParams =(SmartRefreshLayout.LayoutParams) sv6.getLayoutParams();
        linearParams.height=height-810;
        sv6.setLayoutParams(linearParams);
    }
    /**
     * 设置跳转动画
     */
    ...
    public void getY() {
        ...
        //创建请求对象
        Request request = new Request.Builder()
                .url(ServerConfig.SERVER_HOME + "IconItemGetAllNumByYearOut")
                .method("POST", formBody)
                .post(formBody)
                .build();
        //3. 创建CALL对象
...
//                setyDataList(result);
    ...
    private void initViews() {
        sv6 = view.findViewById(R.id.sv6);
        list = view.findViewById(R.id.lv_icon_fragment_out2);
        lineChart = view.findViewById(R.id.demo_linechart5);//绑定控件
        all = view.findViewById(R.id.tv_icon_year);
        refreshLayout = view.findViewById(R.id.srll_out_year);
        average = view.findViewById(R.id.tv_icon_year_average);
    }
}
