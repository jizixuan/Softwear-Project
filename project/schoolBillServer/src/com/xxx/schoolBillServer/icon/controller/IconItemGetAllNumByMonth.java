...
/**
 * Servlet implementation class IconItemGetAllNumByMonth
 */
@WebServlet("/IconItemGetAllNumByMonth")
public class IconItemGetAllNumByMonth extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public IconItemGetAllNumByMonth() {
        super();
