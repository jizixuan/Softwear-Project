...
/**
 * Servlet implementation class IconItemGetAllNumByYear
 */
@WebServlet("/IconItemGetAllNumByYear")
public class IconItemGetAllNumByYear extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public IconItemGetAllNumByYear() {
        super();
...
//			jsonObject.put("date",new SimpleDateFormat("yyyy-MM-dd").format(billItem.getDate()));
		...
		System.out.println("year"+jsonArray.toString());
