...
/**
 * Servlet implementation class GetBillTypeListByNumTypeServlet
 */
@WebServlet("/GetBillTypeListByNumType")
public class GetBillTypeListByNumTypeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetBillTypeListByNumTypeServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<BillType> billTypes=new BillTypeServiceImpl().getTypeListByNumType(numType);
