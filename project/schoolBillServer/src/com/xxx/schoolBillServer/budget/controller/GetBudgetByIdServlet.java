...
/**
 * Servlet implementation class GetBudgetByIdServlet
 */
@WebServlet("/GetBudgetByIdServlet")
public class GetBudgetByIdServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetBudgetByIdServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Budget budget = budgetServiceImpl.getBudgetById(Integer.parseInt(id));
		Gson gson = new Gson();
